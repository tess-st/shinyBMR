...
#
# observe({
#   reqAndAssign(modiml$mod, "model")
#   modiml$mod.name = getLearnerModel(model)$learner$id
#   modiml$type = getLearnerModel(model)$learner$type
#   # modiml$mod.name = getLearnerModel(modiml$mod)$learner$id
#   # modiml$type = getLearnerModel(modiml$mod)$learner$type
# })

output$learnerModel <- renderPrint({
  #reqAndAssign(modeliml$mod, "mod_imp")
  #getLearnerModel(mod_imp)
